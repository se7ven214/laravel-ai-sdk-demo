    ...
    */
    ...
    'providers' => [
        ...
        'gemini' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('GEMINI_TEXT_MODEL', 'gemini-3-flash-preview'),
                    'cheapest' => env('GEMINI_TEXT_MODEL_CHEAPEST', 'gemini-3.1-flash-lite-preview'),
                    'smartest' => env('GEMINI_TEXT_MODEL_SMARTEST', 'gemini-3.1-pro-preview'),
                ],
                'image' => [
